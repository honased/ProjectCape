// Adapated from Nathan Bean's Particle System
...
namespace HonasGame.Particles
{
    ...
    public abstract class ParticleSystem
    {
        ...
        public int DrawOrder { get; set; } = AlphaBlendDrawOrder;
        ...
        private void LoadContent()
        {
            ...
            // load the texture....
            texture = AssetLibrary.GetAsset<Texture2D>(textureFilename);
        ...
        /// <summary>
        /// Draw will use the SpriteBatch to render all of the active particles.
        /// </summary>
        public void Draw(SpriteBatch spriteBatch, GameTime gameTime, Matrix transform)
        {
        ...
        protected void AddParticles(Vector2 where)
        {
            ...
            int numParticles =
                RandomHelper.NextInt(minNumParticles, maxNumParticles);
